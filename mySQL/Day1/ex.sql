...
select book_title, book_author from book where book_title like '%통신%';
...
select * from member where member_id like '%q%'; 
select book_title from book where book_price >= 20000;
	...
	<table border="1">
		...
		<tr height="40">
			<td align="center" colspan="4">
				...
				<input type="button" value="답글쓰기" onclick="location.href='${cp}/board/reWriteForm?num=${bean.num}'">
				<input type="button" value="수정하기">
				<input type="button" value="삭제하기">
				<input type="button" value="목록보기" onclick="location.href='${cp}/board/boardList'" >
			</td>
		</tr>
	</table>
</div>

...
//	forms: 현재 문서의 form을 배열 형태로 저장하는 자바스크립트 내장 객체
	...
	let values = [form.title.value, form.id.value, form.pass.value, form.content.value];
//	console.log(values);
...
//	<tbody> 태그를 얻어온다.
	let tbody = document.getElementById('newtbody');

//	배열에 저장된 데이터를 사용해서 <tbody> 태그에 추가할 행(<tr> 태그)을 만들어 리턴하는
//	함수를 실행해서 리턴된 결과를 추가한다.
